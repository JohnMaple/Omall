...
<!-- 内页顶部 -->
    ...
    <input name="hidCodeID" type="hidden" id="hidCodeID" value="<?php echo $itemid; ?>" />
   ...
   <!--S 底部导航 -->
    <ul id="c_main_menu">
      ...
      <li id="nav_goods">
        <a class="add" codeid="<?php echo $itemid; ?>" href="javascript:;">
...
$(function(){
    ...
    $.getJSON('<?php echo WEB_PATH; ?>/mobile/ajax/goodsSelect/'+codeid+'/'+2,function(data){
      $("body").append(data);
    ...
    $('#nav_buy').click(function(){
        var codeid=$("#hidCodeID").val();
    $.getJSON('<?php echo WEB_PATH; ?>/mobile/ajax/goodsSelect/'+codeid+'/'+3,function(data){
      $("body").append(data);
    $('.selectBar-wrap').slideDown();
...
<script src="<?php echo G_TEMPLATES_JS; ?>/mobile/groupPurchase.js"></script><!-- 载入拼团倒计时 -->