...
<head>
	...
	<!-- <script src="<?php echo G_TEMPLATES_JS; ?>/mobile/straight.js" language="javascript" type="text/javascript"></script> -->
...
<!--这段是旧版注释，无须改动  	<article class="clearfix m-round g-pay-ment mybalance">
            <ul id="ulPayway">
            <?php if($Money >= $MoenyCount): ?>
                <li class="gray9 z-pay-ye ">
                <i id="spBalance" class="z-pay-ment" sel="0"></i>
                <span class="themethod">余额付款<em>（账户余额：<?php echo $Money; ?> 元）</em></span>
                </li>
            <?php  else: ?>
                <li class="gray6 z-pay-ye ">
                <i id="spBalance" class="z-pay-ment" sel="0"></i>
                <a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge" class="z-pay-Recharge">充值</a>
                <span class="themethod">余额付款<em>（账户余额：<?php echo $Money; ?> 元）</em></span>
                </li>
            <?php endif; ?>
            </ul>
